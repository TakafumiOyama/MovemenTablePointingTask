================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: Pointing プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した Pointing には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには Pointing アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
Pointing.h
   ...
   CPointingApp アプリケーション クラスを宣言します。

Pointing.cpp
   これは、アプリケーション クラス CPointingApp を含むメイン アプリケー
   ション ソース ファイルです。
...
res\Pointing.ico
   ...
   アイコンはメイン リソース ファイル Pointing.rc に含まれていま
   す。
...
PointingDlg.h, PointingDlg.cpp - ダイアログ
   これらのファイルは CPointingDlg クラスを含みます。このクラスはアプ
   リケーションのメイン ダイアログの動作を定義します。ダイアログ テンプレートは
   Microsoft Visual C++ で編集可能な Pointing.rc に含まれます。
...
StdAfx.h, StdAfx.cpp
   ...
   Pointing.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
